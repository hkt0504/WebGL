...
VG.UI.DockStripButton.prototype.calcSize=function( canvas )
{
    ...
    if ( this.text.length && !this.iconName ) 
    {
        ...
        size.width=canvas.style.skin.DockStripWidget.TextButton.Size.width;
        size.height=canvas.style.skin.DockStripWidget.TextButton.Size.height;
...
VG.UI.DockStripButton.prototype.paintWidget=function( canvas )
{
    ...
    if ( this.iconName )
    {
        ...
        if ( this.stripWidget.selectedButton !== this ) {
            canvas.draw2DShape( VG.Canvas.Shape2D.RoundedRectangleOutline1px, this.contentRect, canvas.style.skin.DockStripWidget.TextButton.BorderColor );
            canvas.draw2DShape( VG.Canvas.Shape2D.Rectangle, this.contentRect.shrink(1,1), canvas.style.skin.DockStripWidget.TextButton.BackgroundColor );
        } else {
            canvas.draw2DShape( VG.Canvas.Shape2D.RoundedRectangleOutline1px, this.contentRect, canvas.style.skin.DockStripWidget.TextButton.SelectionColor );
            canvas.draw2DShape( VG.Canvas.Shape2D.Rectangle, this.contentRect.shrink(1,1), canvas.style.skin.DockStripWidget.TextButton.SelectionColor );
        }
        canvas.pushFont( canvas.style.skin.DockStripWidget.TextButton.Font );
        canvas.drawTextRect( this.text, this.contentRect, canvas.style.skin.DockStripWidget.TextButton.TextColor, 1, 1 );
        canvas.popFont();
    }
