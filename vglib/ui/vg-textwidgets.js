...
VG.UI.Label=function( text )
{
    ...
    this.font=VG.Font.Font( VG.context.style.skin.DefaultFont );
...
VG.UI.Label.prototype.paintWidget=function( canvas )
{
    ...
    this.font.setFont( VG.context.style.skin.DefaultFont );
...
VG.UI.TextLineEdit=function( text )
{
    ...
    this.font=VG.Font.Font( VG.context.style.skin.TextEdit.Font );
...
VG.UI.TextLineEdit.prototype.calcSize=function( canvas )
{
    ...
    this.font.setFont( VG.context.style.skin.TextEdit.Font );
    canvas.pushFont(this.font);
...
VG.UI.CodeEdit.prototype.paintWidget=function( canvas )
{
    ...
    this.contentRect=this.contentRect.add( 4, 2, -8, -4, this.contentRect );
    ...
    if ( singleLineCommentIndex === -1 && multiLineCommentIndex === -1 && !this.multiLineComment )
    {
        ...
        } else
        {
            ...
            if ( digitIndex !== -1 ) {
                ...
                textPixelOffset+=this.drawJSText( canvas, text, rect.add( textPixelOffset, 0, -textPixelOffset, 0, this.workRect), VG.context.style.skin.CodeEdit.TextColor );
        }
    } else
    {
