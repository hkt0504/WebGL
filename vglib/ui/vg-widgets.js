...
VG.UI.ToolTipWidget.prototype.setToolTip=function( canvas, widget )
{
    ...
    this.height+=canvas.getLineHeight() * this.textLines.length + 2 * canvas.style.skin.ToolTip.BorderSize;
    ...
    this.width+=2 * canvas.style.skin.ToolTip.BorderSize;
    canvas.popFont();
};
...
VG.UI.ToolTipWidget.prototype.paintWidget=function( canvas )
{
    ...
    canvas.draw2DShape( VG.Canvas.Shape2D.RoundedRectangleOutline1px, this.rect, canvas.style.skin.ToolTip.BorderColor );
    canvas.draw2DShape( VG.Canvas.Shape2D.Rectangle, this.rect.shrink( 1, 1, this.contentRect ), canvas.style.skin.ToolTip.BackgroundColor );

    this.contentRect.x+=canvas.style.skin.ToolTip.BorderSize;
    this.contentRect.y+=canvas.style.skin.ToolTip.BorderSize;
